...
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{mean =} \KeywordTok{mean}\NormalTok{(expression),}
            ...
            \DataTypeTok{tcrit =} \KeywordTok{abs}\NormalTok{(}\KeywordTok{pt}\NormalTok{(}\FloatTok{0.025}\NormalTok{, }\DataTypeTok{df =} \KeywordTok{n}\NormalTok{() }\OperatorTok{-}\StringTok{ }\DecValTok{1}\NormalTok{)),}
...
\CommentTok{#> 1 X          11.1 0.3758 0.5094 10.91  11.29}
\CommentTok{#> 2 Y          10   0.3791 0.5094  9.807 10.19}
\end{Highlighting}
\end{Shaded}
