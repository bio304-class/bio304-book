...
In our prior visualizations we've used line plots to depict how gene expression changes over time.  For example here are line plots for 10 genes in the data set, in the cdc28 experiment:

```{r, warning=FALSE, message=FALSE}
genes.of.interest <- unique(spellman.long$gene)[1:10]
