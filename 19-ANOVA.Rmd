...
* Measurement error is not "biological variation" of interest, but rather "technical variation" associated with our ability to measure quantities of interest precisely 
...
```{r, fig.width = 3.25, fig.height = 2.5, fig.align="center", echo=FALSE}
