...
```{r, echo = FALSE, out.width = "60%", fig.align = "center", fig.cap = "Using the File menu to create a new R Notebook.", results="markup"}
...
```{r, echo = FALSE, out.width = "60%", fig.align = "center", fig.cap = "Click the Run button to execute a code chunk.", results="markup"}
...
```{r, echo = FALSE, out.width = "60%", fig.align = "center", fig.cap = "Use the 'Run all chunks above' button to evaluate all previous code chunks.", results="markup"}
...
```{r, echo = FALSE, out.width = "60%", fig.align = "center", fig.cap = "Use the 'Knit to HTML' menu to generate HTML output from your R Notebook", results="markup"}
